...
#i struggled to get the table below to save as immage thus creaqted a separate child .Rmd to knit the table.
#{r child = (file = here::here("03_code","tableR2.Rmd"))}
# the child (or grand-hcild) file is read into the results and discussionSEction .Rmd (wcich itseld is read into the mother file base.Rmd for final or complete document knitting to PDF)
