...
```{r}
ggsave(here("05_fig_output","allStreamsPreModelling.png"), outplot_all_unmoddled, width=10, height=8)

#ggsave(here("05_fig_output","allStreamsPreModelling.pdf"), outplot_all_unmoddled, width=10, height=8)
...
#method1:
#output_file <- here("code/01_code-output","feed_unmoddeled.RDS")  #https://www.middleprofessor.com/files/applied-biostatistics_bookdown/_book/data-reading-writing-and-wrangling.html
...
#In the following steps, transformations are applied. these transformations involve logs, as these logs  will be applied to cummulative percentage values, the last and largest will be 1, and log of 1 is 0, and the second log (log of 0) is "-inf,
...
####plot
#feed and OS
(plot_unmodelled_feed2 <- ggplot(long_meanPct_FeedAndOS, aes(sieve, probability, colour = stream)) +
  geom_line())

print(plot_unmodelled_feed2)
#() brackets do the job of "print()" function.
#print(plot_unmodelled_feed2)
#US only
(plot_unmodelled_feed3 <- ggplot(long_meanPct_US, aes(sieve, probability, colour = stream)) +
  geom_line())

plot_unmodelled_feed2 + plot_unmodelled_feed3

#print(plot_unmodelled_feed3)
###end plot
```
