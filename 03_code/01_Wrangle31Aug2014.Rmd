This is the Starting point in this project.

this file imports the raw data and wrangle to means of the repeated tests.

+ import  
+ wrangle
+ exports preocessed data to foder ~03code_output for use in futher processing / analasys.
...
```{r, include = FALSE}
#Package::Function "here::here" keeps file paths relative to the project folder:
library("here")
...
RawPSD <- cbind(sieve, Feed13MeanPct, Feed14MeanPct,OS13MeanPct, OS14MeanPct,US13MeanPct, US14MeanPct)
...
```{r }
write.csv(FeedRawPSD, here::here("03_code/01_code-output","FeedRawPSD.csv"),row.names = FALSE)
write.csv(OSRawPSD, here::here("03_code/01_code-output","OSRawPSD.csv"),row.names = FALSE)
write.csv(USRawPSD, here::here("03_code/01_code-output","USRawPSD.csv"),row.names = FALSE)


write.csv(RawPSD, here::here("03_code/01_code-output","RawPSD.csv"),row.names = FALSE)
