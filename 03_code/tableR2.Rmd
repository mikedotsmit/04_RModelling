...
Reason: i cant the table to gerate from within a code chunk or r.script, ub only once knitted doe the table show.., so for now i 'll keep it sepparate here in this .Rmd.
