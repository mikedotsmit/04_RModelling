...
Coef_RR1 <- read.csv(file = here::here("03_code/01_code-output","CoefRR1.csv"))
Coef_RR2 <- read.csv(file = here::here("03_code/01_code-output","CoefRR2.csv"))
Coef_GGS1 <- read.csv(file = here::here("03_code/01_code-output","CoefGGS1.csv"))
Coef_GGS2 <- read.csv(file = here::here("03_code/01_code-output","CoefGGS2.csv"))
