...
```{r, echo = FALSE, eval = TRUE, include = TRUE, out.width='75%', fig.align='center', fig.cap='...'}
knitr::include_graphics(here::here("05_fig_output",'allStreamsPreModelling.png'))
```
...
#knitr::include_graphics(path = "05_fig_output/allStreamsPreModelling.png")
#```
#<hr></center>
# <<center><chr>
# ![](05_fig_output/allStreamsPreModelling.png){width=65}




# <<center><chr>
# ![plotTitle](here::here("05_fig_output","allStreamsPreModelling.pdf"))
